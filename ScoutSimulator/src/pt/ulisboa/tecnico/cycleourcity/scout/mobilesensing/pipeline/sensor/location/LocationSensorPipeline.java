 ...
 *
 */
public class LocationSensorPipeline implements SensorProcessingPipeline, FeatureExtractor {
    ...
    public void run() {
        ...
        logger.log(ScoutLogger.VERBOSE, LOG_TAG,
                TAG+"executing pipeline for "+sampleQueue.size()+" location samples.");
    ...
    public static class TrimStage implements Stage {
        ...
        public void execute(PipelineContext pipelineContext) {
            ...
            for(JsonObject sample : input){
                ...
                scoutTime = sample.get(SensingUtils.SCOUT_TIME).getAsString();
                ...
                trimmedSample.addProperty(SensingUtils.SCOUT_TIME, scoutTime);
