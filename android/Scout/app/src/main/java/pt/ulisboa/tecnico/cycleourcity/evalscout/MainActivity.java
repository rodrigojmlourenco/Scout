...
import pt.ulisboa.tecnico.cycleourcity.evalscout.calibration.exceptions.NotYetCalibratedException;
import pt.ulisboa.tecnico.cycleourcity.evalscout.config.exceptions.NotInitializedException;
...
public class MainActivity extends ActionBarActivity {
    ...
    //Funf
    public static final String PIPELINE_NAME = "evaluation";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(pt.ulisboa.tecnico.cycleourcity.evalscout.R.layout.activity_main);


        onInitChecks();

        // Runs a save action if pipeline is enabled
        saveSession = (Button) findViewById(pt.ulisboa.tecnico.cycleourcity.evalscout.R.id.archive);
        ...
        startSession = (Button) findViewById(pt.ulisboa.tecnico.cycleourcity.evalscout.R.id.startSession);
        stopSession = (Button) findViewById(pt.ulisboa.tecnico.cycleourcity.evalscout.R.id.stopSession);
        startSession.setEnabled(false);
        stopSession.setEnabled(false);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(pt.ulisboa.tecnico.cycleourcity.evalscout.R.menu.menu_main, menu);

        MenuItem mView = menu.findItem(pt.ulisboa.tecnico.cycleourcity.evalscout.R.id.myswitch);
        Switch mSwitch = (Switch) mView.getActionView().findViewById(pt.ulisboa.tecnico.cycleourcity.evalscout.R.id.switchForActionBar);
        ...
        getSupportActionBar().setLogo(R.mipmap.trends);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        Intent intent;
        switch (id){
            case pt.ulisboa.tecnico.cycleourcity.evalscout.R.id.action_settings:
                intent = new Intent(this, SettingsActivity.class);
                startActivity(intent);
                return true;
            case pt.ulisboa.tecnico.cycleourcity.evalscout.R.id.action_calibrate:
    ...
    private void setupLandscapeModeWidgets(){
        ...
        goodAsphaltBtn      = (Button) findViewById(pt.ulisboa.tecnico.cycleourcity.evalscout.R.id.goodAsphaltBtn);
        goodCobblestoneBtn  = (Button) findViewById(pt.ulisboa.tecnico.cycleourcity.evalscout.R.id.goodCobblestoneBtn);
        goodGravelBtn       = (Button) findViewById(pt.ulisboa.tecnico.cycleourcity.evalscout.R.id.goodGravelBtn);
        badAsphaltBtn       = (Button) findViewById(pt.ulisboa.tecnico.cycleourcity.evalscout.R.id.badAsphaltBtn);
        badCobblestoneBtn   = (Button) findViewById(pt.ulisboa.tecnico.cycleourcity.evalscout.R.id.badCobblestoneBtn);
        badGravelBtn        = (Button) findViewById(pt.ulisboa.tecnico.cycleourcity.evalscout.R.id.badGravelBtn);
        ...
        Button.OnClickListener pavementButtonListener = new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (v.getId()){
                    case pt.ulisboa.tecnico.cycleourcity.evalscout.R.id.goodAsphaltBtn:
                        pavement = PavementType.Pavements.AsphaltGood;
                        break;
                    case pt.ulisboa.tecnico.cycleourcity.evalscout.R.id.goodCobblestoneBtn:
                        pavement = PavementType.Pavements.CobblestoneGood;
                        break;
                    case pt.ulisboa.tecnico.cycleourcity.evalscout.R.id.goodGravelBtn:
                        pavement = PavementType.Pavements.GravelGood;
                        break;
                    case pt.ulisboa.tecnico.cycleourcity.evalscout.R.id.badAsphaltBtn:
                        pavement = PavementType.Pavements.AsphaltBad;
                        break;
                    case pt.ulisboa.tecnico.cycleourcity.evalscout.R.id.badCobblestoneBtn:
                        pavement = PavementType.Pavements.CobblestoneBad;
                        break;
                    case pt.ulisboa.tecnico.cycleourcity.evalscout.R.id.badGravelBtn:
                        pavement = PavementType.Pavements.GravelGood;
                        break;
                    default:
                ...
                ((Button)v).setBackground(getDrawable(pt.ulisboa.tecnico.cycleourcity.evalscout.R.color.cyan));
    ...
    private void setupPortraitModeWidgets(){
        //Pavement Type Group
        final PavementType pavementType = PavementType.getInstance();
        pavementTypeGroup = (RadioGroup) findViewById(pt.ulisboa.tecnico.cycleourcity.evalscout.R.id.pavementTypeGroup);
        pavementTypeGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                switch (checkedId) {
                    case pt.ulisboa.tecnico.cycleourcity.evalscout.R.id.isAsphalt:
                        pavement = PavementType.Pavements.asphalt;
                        break;
                    case pt.ulisboa.tecnico.cycleourcity.evalscout.R.id.isCobblestone:
                        pavement = PavementType.Pavements.cobblestone;
                        break;
                    case pt.ulisboa.tecnico.cycleourcity.evalscout.R.id.isGravel:
        ...
        //Testing - Offload
        offloadBtn = (Button) findViewById(pt.ulisboa.tecnico.cycleourcity.evalscout.R.id.offloadBtn);
        ...
        //Device State Mockup
        mockupBattSeekBar   = (SeekBar) findViewById(pt.ulisboa.tecnico.cycleourcity.evalscout.R.id.mockupBattBar);
        mockupBattText      = (TextView)findViewById(pt.ulisboa.tecnico.cycleourcity.evalscout.R.id.mockupBattText);
        ...
        mockupNetBar = (SeekBar) findViewById(pt.ulisboa.tecnico.cycleourcity.evalscout.R.id.mockupNetBar);
        mockupNetText= (TextView)findViewById(pt.ulisboa.tecnico.cycleourcity.evalscout.R.id.mockupNetText);
