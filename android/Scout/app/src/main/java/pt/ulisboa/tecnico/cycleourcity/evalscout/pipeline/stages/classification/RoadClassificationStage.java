...
public abstract class RoadClassificationStage implements Stage {
    ...
    protected final JsonObject generateClassificationStub(JsonObject featureVector){
        ...
        classification.addProperty(SensingUtils.GeneralFields.SENSOR_TYPE, pt.ulisboa.tecnico.cycleourcity.scout.pipeline.RoadConditionMonitoringPipeline.SENSOR_TYPE);
