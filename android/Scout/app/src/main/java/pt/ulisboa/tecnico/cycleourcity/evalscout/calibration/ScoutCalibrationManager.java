package pt.ulisboa.tecnico.cycleourcity.evalscout.calibration;
...
public class ScoutCalibrationManager {
    ...
    private ScoutCalibrationManager(SharedPreferences calibrationPrefs)
        ...
        if(calibrationPrefs == null ||
            !calibrationPrefs.getBoolean(SensorCalibrator.LinearAccelerationCalibrator.CalibrationKeys.CALIBRATED, false)){
        ...
        x = calibrationPrefs.getFloat(SensorCalibrator.LinearAccelerationCalibrator.CalibrationKeys.X_OFFSET, 0.0f);
        y = calibrationPrefs.getFloat(SensorCalibrator.LinearAccelerationCalibrator.CalibrationKeys.Y_OFFSET, 0.0f);
        z = calibrationPrefs.getFloat(SensorCalibrator.LinearAccelerationCalibrator.CalibrationKeys.Z_OFFSET, 0.0f);
