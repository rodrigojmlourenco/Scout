...
public class LocationSensorPipeline implements ISensorPipeline, FeatureExtractor {
    ...
    public static class TrimStage implements Stage {
        ...
        public void execute(PipelineContext pipelineContext) {
            ...
            for(JsonObject sample : input){
                ...
                elapsedRealtimeNanos = sample.get(SensingUtils.LocationKeys.ELAPSED_TIME_NANOS).getAsDouble();
    ...
    public static class MergeSamplesStage implements Stage {
        ...
        private boolean closelyRelated(JsonObject sample1, JsonObject sample2){
            ...
            t1 = SensingUtils.LocationSampleAccessor.getElapsedRealTimeMillis(sample1);
            t2 = SensingUtils.LocationSampleAccessor.getElapsedRealTimeMillis(sample2);
        ...
        private JsonObject mergeSamples(JsonObject sample1, JsonObject sample2){
            ...
            long elapsed1, elapsed2, newElapsed;
            ...
            e1 = SensingUtils.LocationSampleAccessor.getElapsedRealTimeMillis(sample1);
            e2 = SensingUtils.LocationSampleAccessor.getElapsedRealTimeMillis(sample2);
            time1 = SensingUtils.LocationSampleAccessor.getTime(sample1);
            time2 = SensingUtils.LocationSampleAccessor.getTime(sample2);
            ...
            elapsed1 = sample1.get(SensingUtils.LocationKeys.ELAPSED_TIME_NANOS).getAsLong();
            elapsed2 = sample2.get(SensingUtils.LocationKeys.ELAPSED_TIME_NANOS).getAsLong();
            ...
            if(acc1 == acc2){
                ...
                newLat = (lat1 + lat2)/2;
                newLon = (lon1 + lon2)/2;
                newElapsed = (elapsed1 + elapsed2)/2;
                newTimestamp = (t1 + t2)/2;
                newTime = (time1+time2)/2;
            }else {
            ...
            merged.addProperty(SensingUtils.LocationKeys.ELAPSED_TIME_NANOS, newElapsed);
